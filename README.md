...
2021-1-26至2021-2-21 不务正业，期间学习Python基础，阅读完《C++ Primer》第II部分
...
| 日期 | 数学                  | 物理          | 编程                                     | 读书                     | 其他                      |
| ---- | --------------------- | ------------- | ---------------------------------------- | ------------------------ | ------------------------- |
| 1.12 | 微 1.4                | 物理视频 -p4  | TICpp -p63 dsa讲义 -p89                  | 史纲 -chap3              | 小程序+1 功能             |
| 1.13 | 微 1.5                | 物理视频 -p7  | TICpp -p90 dsa讲义 -p176                 | 史纲 -chap4              | 小程序+0.5功能            |
| 1.14 | 微 1.6 D1             |               | TICpp -p120                              | 史纲 -chap5              | 小程序+2 功能             |
| 1.15 | 微 1.6 D2             | 物理视频 -p11 | TICpp -p150 几道简单 cf 题 dsa讲义 -p290 | 史纲 -chap6              | 小程序+0.5功能            |
| 1.16 | 微 1.7                | 物理视频 -p13 | TICpp -p180 MSinCS -c3                   |                          |                           |
| 1.17 | 微 1.8                | 物理视频 -p16 | TICpp-p215 dsa讲义 -p388                 | 《马克思传》 史纲 -chap7 |                           |
| 1.18 | 微 1.9                | 物理视频 -p18 |                                          | 史纲 -chap8              | 小程序+2功能              |
| 1.19 | 微 1.10               | 物理视频 -p20 | TICpp -p260 dsa讲义 -p520                | 史纲 -chap9              | 小程序+0.25功能           |
| 1.20 | 微 2.1                |               | TICpp -p300                              | 史纲 -chap10             | 小程序+1功能              |
| 1.21 | 微 2.2 D1             | 物理视频 -p22 | TICpp -p330 dsa讲义 -p590                | 史纲 -chap11 书A -p15    | 小程序+0.5功能            |
| 1.22 | 微 2.2 D2 微 2.3      | 物理视频 -p23 | TICpp -p360                              | 书A -p28                 |                           |
| 1.23 |                       |               | TIcpp -p400 dsa讲义 -p660                | 书A -p45                 | （今天出去玩了）          |
| 1.24 | 微 2.4                | 物理视频 -p25 | TIcpp -p420                              | 书A -p48                 | 小程序开发                |
| 1.25 | 微 3.1                |               | TICpp -p450 dsa讲义 -p720 avl tree实现   | 书A -p60                 |                           |
| 1.26 | 微 3.2                | 物理视频 -p27 | TICpp -p470                              | 书A -p65                 |                           |
| 1.27 | 微 3.3 D1             |               | TICpp -p500                              | 书A -p72                 |                           |
| 1.28 | 微 3.3 D2             | 物理视频 -p29 |                                          |                          | 小程序开发 奇怪的程序开发 |
| 1.29 | 微 3.4 吐槽：太多了！ |               | TICpp -p530                              | 书A -p81                 |                           |
| 1.30 | 微 3.5                |               | TICpp -p550 CppPP chap13                 | 一些书                   |                           |
| 1.31 | 微 4.1                |               |                                          | 书A -p95 其他一些书      |                           |
| 2.1  |                       |               | 学习 beamer OOP `class`                  | 一些书                   |                           |
| 2.2  | 微 4.2                |               | 学习 beamer                              | 书A -p110 一些书         |                           |
...
| 2.9  | 微 4.6                |               |                                          |                          |                           |
| 2.10 | 微 5.1 D1             |               | TICpp -p670 CS:APP -p120                 |                          |                           |
| 2.11 |                       |               | TICpp -p680                              | 一些书                   |                           |
| 2.12 |                       |               | TICpp -p700                              |                          |                           |
| 2.13 |                       |               | TICpp -p730 CS:APP -p140                 |                          |                           |
